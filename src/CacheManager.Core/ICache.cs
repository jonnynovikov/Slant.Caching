...
namespace CacheManager.Core
{
    ...
    public interface ICache<TCacheValue> : IDisposable
    {
        ...
        /// </exception>
        Task<bool> Add(string key, TCacheValue value);
        ...
        /// </exception>
        Task<bool> Add(string key, TCacheValue value, string region);
        ...
        /// </exception>
        Task<bool> Add(CacheItem<TCacheValue> item);
        ...
        Task ClearRegion(string region);
        ...
        /// <param name="region">The cache region.</param>
        /// <returns><c>True</c> if the <paramref name="key"/> exists, <c>False</c> otherwise.</returns>
        Task<bool> Exists(string key, string region);
        ...
        Task<TCacheValue> Get(string key);
        ...
        /// </exception>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1716:IdentifiersShouldNotMatchKeywords", MessageId = "Get", Justification = "Maybe at some point.")]
        Task<TCacheValue> Get(string key, string region);
        ...
        /// </exception>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1716:IdentifiersShouldNotMatchKeywords", MessageId = "Get", Justification = "Maybe at some point.")]
        Task<TOut> Get<TOut>(string key, string region);
        ...
        /// <exception cref="ArgumentNullException">If the <paramref name="key"/> is null.</exception>
        Task<CacheItem<TCacheValue>> GetCacheItem(string key);
        ...
        /// If the <paramref name="key"/> or <paramref name="region"/> is null.
        /// </exception>
        Task<CacheItem<TCacheValue>> GetCacheItem(string key, string region);
        ...
        /// If the <paramref name="key"/> or <paramref name="value"/> is null.
        /// </exception>
        Task Put(string key, TCacheValue value);
        ...
        /// If the <paramref name="key"/>, <paramref name="value"/> or <paramref name="region"/> is null.
        /// </exception>
        Task Put(string key, TCacheValue value, string region);
        ...
        /// If the <paramref name="item"/> or the item's key or value is null.
        /// </exception>
        Task Put(CacheItem<TCacheValue> item);
