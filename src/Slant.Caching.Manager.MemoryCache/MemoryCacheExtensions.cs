...
internal static class MemoryCacheExtensions
{
    ...
    public static bool Contains(this Microsoft.Extensions.Caching.Memory.MemoryCache cache, object key)
    {
        object? temp;
        return cache.TryGetValue(key, out temp);
    }

    internal static void RegisterChild(this Microsoft.Extensions.Caching.Memory.MemoryCache cache, object parentKey, object childKey)
    {
    ...
    internal static void RemoveChilds(this Microsoft.Extensions.Caching.Memory.MemoryCache cache, object region)
    {
