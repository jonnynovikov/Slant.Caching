...
public static class CacheFactory
{
    ...
    {
        return Build<object>(Guid.NewGuid().ToString("N"), settings);
    }
    ...
    /// Thrown on certain configuration errors related to the cache handles.
    /// </exception>
    public static ICacheManager<TCacheValue> Build<TCacheValue>(string? cacheName,
    ...
    {
        return Build<TCacheValue>(Guid.NewGuid().ToString("N"), settings);
    }
    ...
    {
        return Build(cacheValueType, Guid.NewGuid().ToString("N"), settings);
    }
    ...
    public static ICacheManager<TCacheValue> FromConfiguration<TCacheValue>(string? cacheName)
    {
        ...
        return FromConfiguration<TCacheValue>(cacheName, cfg);
    }
    ...
    public static object FromConfiguration(Type cacheValueType, string? cacheName)
    {
        ...
        return FromConfiguration(cacheValueType, cacheName, cfg);
    }
    ...
    public static ICacheManager<TCacheValue> FromConfiguration<TCacheValue>(
        ICacheManagerConfiguration configuration)
    {
        return FromConfiguration<TCacheValue>(Guid.NewGuid().ToString("N"), configuration);
    }
    ...
    {
        return FromConfiguration(cacheValueType, Guid.NewGuid().ToString("N"), configuration);
    }
}