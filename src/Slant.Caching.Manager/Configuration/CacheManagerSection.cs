...
public sealed class CacheManagerSection : ConfigurationSection
{
    ...
    public CacheHandleDefinitionCollection CacheHandleDefinitions =>
        (CacheHandleDefinitionCollection) this[HandlesName];
...
public sealed class CacheHandleDefinition : ConfigurationElement
{
    ...
    {
        get => (ExpirationMode) this["defaultExpirationMode"];
        set => this["defaultExpirationMode"] = value;
    }
    ...
    {
        get => (string) this["defaultTimeout"];
...
/// </summary>
public sealed class CacheHandleDefinitionCollection : ConfigurationElementCollection,
    IEnumerable<CacheHandleDefinition>
{
    /// <summary>
    ...
    public new IEnumerator<CacheHandleDefinition> GetEnumerator()
    {
        ...
        enu.Reset();
        while (enu.MoveNext()) yield return (CacheHandleDefinition) enu.Current;
    }
...
/// </summary>
public sealed class CacheManagerCollection : ConfigurationElementCollection,
    IEnumerable<CacheManagerHandleCollection>
{
    /// <summary>
    /// Returns an enumerator that iterates through the collection.
    /// </summary>
    ...
    public new IEnumerator<CacheManagerHandleCollection> GetEnumerator()
    {
        var enu = base.GetEnumerator();
        enu.Reset();
        while (enu.MoveNext()) yield return (CacheManagerHandleCollection) enu.Current;
    }
...
public sealed class CacheManagerHandle : ConfigurationElement
{
    ...
    {
        get => (string) this["expirationMode"];
    ...
    {
        get => (bool) this["isBackplaneSource"];
        set => this["isBackplaneSource"] = value;
    }
...
public sealed class CacheManagerHandleCollection : ConfigurationElementCollection, IEnumerable<CacheManagerHandle>
{
    ...
    {
        get => (string) this[BackplaneNameKey];
        set => this[BackplaneNameKey] = value;
    }
    ...
    {
        get => (string) this[BackplaneTypeKey];
        set => this[BackplaneTypeKey] = value;
    }
    ...
    {
        get => (string) this[SerializerTypeKey];
        set => this[SerializerTypeKey] = value;
    }
    ...
    {
        get => (bool) this[EnableStatisticsKey];
        set => this[EnableStatisticsKey] = value;
    }
    ...
    {
        get => (int?) this[RetryTimeoutKey];
        set => this[RetryTimeoutKey] = value;
    }
    ...
    {
        get => (CacheUpdateMode) this[UpdateModeKey];
        set => this[UpdateModeKey] = value;
    }
    ...
    public new IEnumerator<CacheManagerHandle> GetEnumerator()
    {
        var enu = base.GetEnumerator();
        enu.Reset();
        while (enu.MoveNext()) yield return (CacheManagerHandle) enu.Current;
    }
