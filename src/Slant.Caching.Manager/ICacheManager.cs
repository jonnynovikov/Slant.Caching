...
public interface ICacheManager<TCacheValue> : ICache<TCacheValue>
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design",
        ...
        Justification = "Will usually not be used in public API anyways.")]
    ...
    /// If either <paramref name="key"/> or <paramref name="valueFactory"/> is null.
    /// </exception>
    CacheItem<TCacheValue> GetOrAdd(string key, string? region,
    ...
    /// If either <paramref name="key"/> or <paramref name="valueFactory"/> is null.
    /// </exception>
    bool TryGetOrAdd(string key, Func<string, CacheItem<TCacheValue>> valueFactory,
    ...
    /// as Get plus Put.
    /// </remarks>
    bool TryUpdate(string key, string region, Func<TCacheValue, TCacheValue> updateValue, int maxRetries,
