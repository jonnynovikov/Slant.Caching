...
public static class LoggerExtensions
{
    ...
    public static void LogDebug(this ILogger logger, int eventId, Exception exception, string message,
        params object?[] args)
    {
        if (logger == null) throw new ArgumentNullException(nameof(logger));
    ...
    public static void LogInfo(this ILogger logger, int eventId, Exception exception, string message,
        params object?[] args)
    {
        if (logger == null) throw new ArgumentNullException(nameof(logger));
    ...
    public static void LogTrace(this ILogger logger, int eventId, Exception exception, string message,
        params object?[] args)
    {
        if (logger == null) throw new ArgumentNullException(nameof(logger));
    ...
    public static void LogWarn(this ILogger logger, int eventId, Exception exception, string message,
        params object?[] args)
    {
        if (logger == null) throw new ArgumentNullException(nameof(logger));
    ...
    private class FormatMessage
    {
        ...
        {
            if (_args == null || _args.Length == 0) return _format;
