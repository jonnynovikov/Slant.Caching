...
public class CacheManagerRedisEventsTest
{
    ...
    public class LongRunningEventTestBase
    {
            ...
            bool expectValue = true)
        {
            ...
            if (expectValue) resultArgs.Value.Should().Be("value");
    ...
    public class RedisSpecific : LongRunningEventTestBase
    {
        ...
        {
            var cfg = new ConfigurationBuilder()
                .WithRedisConfiguration("redis", $"{TestManagers.RedisHost}:{TestManagers.RedisPort}, allowAdmin=true",
                    0, true)
                .WithJsonSerializer()
        ...
        using (var cache = CacheFactory.Build<string>(
                   s => s
                       .WithUpdateMode(CacheUpdateMode
                           .None) // prevent trigger cleanup above (not implemented in the mock handle)
    ...
    private class CustomRemoveEventTestHandle : BaseCacheHandle<string>
    {
        ...
        protected override ILogger Logger => new NullLogger();
