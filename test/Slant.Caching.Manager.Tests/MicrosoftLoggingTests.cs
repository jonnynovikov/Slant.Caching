...
public class MicrosoftLoggingTests
{
    ...
    {
        var services = new ServiceCollection();
        var provider = services.AddLogging(b => b.AddConsole().SetMinimumLevel(LogLevel.Information))
    ...
    {
        var services = new ServiceCollection();
        var provider = services.AddLogging(b => b.AddConsole().SetMinimumLevel(LogLevel.Warning))
            .BuildServiceProvider();
        var external = provider.GetRequiredService<ILoggerFactory>();
    ...
    {
        var services = new ServiceCollection();
        var provider = services.AddLogging(b => b.AddConsole().SetMinimumLevel(LogLevel.Critical))
            .BuildServiceProvider();
        var external = provider.GetRequiredService<ILoggerFactory>();
