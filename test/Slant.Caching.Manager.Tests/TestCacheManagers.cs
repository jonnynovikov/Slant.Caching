...
namespace Slant.Caching.Manager.Tests
{
    ...
    public static class TestManagers
    {
        ...
        public static ICacheManager<object> WithRedisCacheBondBinary
        {
            get
            {
                ...
                if (_databaseCount >= NumDatabases) _databaseCount = StartDbCount;
        ...
        public static ICacheManager<object> WithRedisCacheJson
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.Json);
            }
        }
        ...
        public static ICacheManager<object> WithRedisCacheJsonNoLua
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.Json, false);
            }
        }
        ...
        public static ICacheManager<object> WithRedisCacheDataContract
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.DataContract);
            }
        }
        ...
        public static ICacheManager<object> WithRedisCacheDataContractJson
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.DataContractJson);
            }
        }
        ...
        public static ICacheManager<object> WithRedisCacheDataContractGzJson
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.DataContractGzJson);
            }
        }
        ...
        public static ICacheManager<object> WithRedisCacheDataContractBinary
        {
            get
            {
                ...
                return CreateRedisCache(_databaseCount, false, Serializer.DataContractBinary);
            }
        }
        ...
        public static ICacheManager<object> WithDicAndRedisCache
        {
            get
            {
                ...
                return CreateRedisAndDicCacheWithBackplane(_databaseCount, false, Guid.NewGuid().ToString(),
                    useLua: true);
            }
        }
        ...
        public static ICacheManager<object> WithMemoryAndDictionaryHandles
            => CacheFactory.FromConfiguration<object>(
                BaseConfiguration
                    ...
                    .WithSystemRuntimeCacheHandle()
                    .EnableStatistics()
                    .And.WithSystemRuntimeCacheHandle("LimitedCacheHandle",
                        new SystemRuntimeCaching.RuntimeMemoryCacheOptions()
                            {PhysicalMemoryLimitPercentage = 20, CacheMemoryLimitMegabytes = 200})
                    .EnableStatistics()
                    .WithExpiration(ExpirationMode.Absolute, TimeSpan.FromSeconds(1000))
                    .And.WithDictionaryHandle()
                    .EnableStatistics()
        ...
        public static ICacheManager<object> CreateRedisAndDicCacheWithBackplane(int database = 0,
            bool sharedRedisConfig = true, string channelName = null, Serializer serializer = Serializer.Proto,
            bool useLua = true)
        {
            if (database > NumDatabases) throw new ArgumentOutOfRangeException(nameof(database));
            ...
            builder.WithUpdateMode(CacheUpdateMode.Up)
                ...
                .WithRedisConfiguration(redisKey, config =>
                {
                    ...
                    if (!useLua) config.UseCompatibilityMode("2.4");
                })
        ...
        public static ICacheManager<object> CreateDicCacheWithBackplane(bool sharedRedisConfig = true,
        ...
        public static ICacheManager<object> CreateRedisCache(int database = 0, bool sharedRedisConfig = true,
            Serializer serializer = Serializer.GzJson, bool useLua = true)
        {
            if (database > NumDatabases) throw new ArgumentOutOfRangeException(nameof(database));
        ...
        public static ICacheManager<T> CreateRedisCache<T>(int database = 0, bool sharedRedisConfig = true,
            Serializer serializer = Serializer.GzJson)
        {
            if (database > NumDatabases) throw new ArgumentOutOfRangeException(nameof(database));
    ...
    {
        public static ConfigurationBuilderCachePart TestSerializer(this ConfigurationBuilderCachePart part,
